    ...
    <div className="min-h-screen w-full bg-[#FFFFFF] flex items-center justify-center p-4 sm:p-6 lg:p-12 relative overflow-x-hidden">
      ...
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 mx-auto">
        ...
        <div className="w-full lg:w-[450px] shrink-0 flex justify-center">
          <div className="w-full max-w-[450px] bg-white/90 backdrop-blur-[18px] border-[3px] border-[#DECEFF] rounded-[32px] sm:rounded-[38px] lg:rounded-[41.6px] p-6 sm:p-8 lg:p-9 shadow-[0_52px_78px_-19.5px_rgba(79,55,138,0.08)] flex flex-col space-y-6">
            
            {/* Logo / Brand mark */}
            <div className="flex justify-start">
              <div className="w-[54px] h-[54px] sm:w-[59px] sm:h-[59px] rounded-[18px] bg-gradient-to-br from-[#8B5CF6] to-[#6366F1] flex items-center justify-center shadow-[0_0_27px_rgba(139,92,246,0.4)]">
                <span className="text-white font-bold text-[22.7px]">M</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
              ...
              <button
                type="submit"
                className="w-full h-[50px] sm:h-[53.2px] bg-gradient-to-r from-[#8B5CF6] via-[#6366F1] to-[#EC4899] text-white font-bold text-[14.3px] rounded-[16.3px] flex items-center justify-center transition-all duration-200 hover:opacity-95 active:scale-[0.99] shadow-md mt-2"
              >
                Sign In
              </button>
            </form>
            ...
            {/* Doctor Login & Employee Login Bottom Buttons */}
            <div className="grid grid-cols-2 gap-3 pt-2">
              <button
                type="button"
                onClick={() => onNavigate('/dashboard')}
                className="h-[48px] sm:h-[53.4px] bg-gradient-to-r from-[#6D28D9]/90 to-[#5B21B6]/90 text-white font-bold text-[11.7px] rounded-[16.3px] flex items-center justify-center gap-1.5 transition-all duration-200 hover:opacity-95 active:scale-[0.98] px-2 shadow-sm"
              >
