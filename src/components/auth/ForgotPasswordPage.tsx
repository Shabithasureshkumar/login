          ...
          >
            ...
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p
                ...
                "
              >
                Enter your registered email address or mobile number and
            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <button
                  ...
                  className="
                    ...
                    hover:shadow-[0_12px_28px_rgba(124,58,237,0.25)]
                    active:scale-[0.99]
                    shadow-[0_13px_19.5px_-3.9px_rgba(79,55,138,0.2)]
                    mt-2
                  "
                >
              ...
              <div className="flex flex-col items-center text-center space-y-4 py-4">
                ...
                <h3 className="text-xl font-bold text-[#1D1B20]">
